...
public class Prac {
    ...
    public static void main(String[] args) throws NotValidInnException {
        ...
        if (person.equals(person1)) {System.out.println("Authentication completed");
        } else {
...
class Person {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(INN, person.INN) && Objects.equals(surName, person.surName)
                && Objects.equals(firstName, person.firstName) && Objects.equals(middleName, person.middleName);
    }
}
